    ...
    if (this.state.currentUser == null) {
      ...
      app = (
        ...
        <Switch>
          ...
          />
          <Route exact path="/VideosInspirantes" component={VideosInspirantes} />
          <Route exact path="/RetrouverSaConfianceEnSoi" component={RetrouverSaConfianceEnSoi} />
          ...
          <Route exact path="/MaitriserSonSommeil" component={MaitriserSonSommeil} />
    ...
    return (
      <div className="App">
        <header className="header">
          <img className="logo" alt="Serena" src='logo_transparent.png' />
          {nav}
        </header>
        {app}
